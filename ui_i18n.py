...
LANGUAGES = {
    "nl": {
        ...
        "ai_disclaimer": "Deze overdenkingen zijn met behulp van AI opgesteld op basis van de preek.",
    ...
    "en": {
        ...
        "ai_disclaimer": "These devotionals were created with the help of AI, based on the sermon.",
    ...
    "af": {
        ...
        "ai_disclaimer": "Hierdie oordenkings is met behulp van KI opgestel, gebaseer op die preek.",
