...
window.AfterSermonI18n = (() => {
  ...
  const en = {
    ...
    ,"Wil je elke week zelf goedkeuren vóór verzending?":"Do you want to approve before sending each week?","AfterSermon gebruikt AI":"AfterSermon uses AI","De teksten worden automatisch gegenereerd op basis van de preek. De kwaliteit is goed genoeg om direct te versturen — je hoeft niets te controleren. Kies \"volledig automatisch\" en de AI doet het werk.":"The texts are generated automatically from the sermon. Quality is good enough to send immediately — no review needed. Choose \"fully automatic\" and AI does the work.","Aanbevolen: geen controle.":"Recommended: no review.","Je bespaart jezelf wekelijks werk. Inschrijvers ontvangen de teksten altijd op tijd.":"You save yourself weekly work. Subscribers always receive the texts on time.","Volledig automatisch (aanbevolen)":"Fully automatic (recommended)","Ik wil elke week eerst goedkeuren":"I want to approve first each week","Stuur de goedkeuringsmail naar:":"Send the approval email to:","Laat leeg om de goedkeuringsmail naar je inlogadres te sturen (":"Leave empty to send the approval email to your login address (","Volledig automatisch":"Fully automatic","Met goedkeuring":"With approval","Meer opties (verzendmoment, taal, bijbelvertaling, toon) vind je bij Instellingen.":"More options (send time, language, Bible translation, tone) are under Settings.","Kleur en logo (voor de e-mails en pagina's)":"Colour and logo (for emails and pages)"
    ...
    ,"Wat wil je ontvangen?":"What would you like to receive?","De inschrijving voor deze kerk is op dit moment gesloten.":"Signups for this church are currently closed.","Inschrijving open — gemeenteleden kunnen zich via de QR/link aanmelden en zelf kiezen wat ze willen ontvangen":"Signups open — members can register via the QR/link and choose what they want to receive themselves"
    ,"De eerste keer duurt even: de preek wordt gedownload, getranscribeerd en geanalyseerd. Zet bij stap 3 „automatisch ophalen\" aan, dan gebeurt dit vanzelf na de dienst en hoef je nergens op te wachten.":"The first time takes a moment: the sermon is downloaded, transcribed and analysed. Turn on “fetch automatically” in step 3, then this happens by itself after the service and you never have to wait."
    ,"maakt van je zondagse preek automatisch een weekboekje: een korte samenvatting en zeven dagoverdenkingen met vragen voor volwassenen en kinderen — en mailt die elke week naar je gemeenteleden.":"automatically turns your Sunday sermon into a weekly booklet: a short summary and seven daily devotionals with questions for adults and children — and emails it to your members every week.","Koppel je YouTube- of Kerkdienstgemist-kanaal en het gaat vanzelf.":"Connect your YouTube or Kerkdienstgemist channel and it runs by itself.","Bekijk de demo":"View the demo","Je account maak je aan bij Community Tools.":"You create your account at Community Tools.","Daar beheer je al je kerk-apps op één plek. Je maakt (of gebruikt) daar je account en opent AfterSermon vervolgens vanuit Community Tools.":"That's where you manage all your church apps in one place. You create (or use) your account there and then open AfterSermon from Community Tools.","Al een account? Open AfterSermon via Community Tools →":"Already have an account? Open AfterSermon via Community Tools →"
  };
  const af = {
    ...
    ,"Wat wil je ontvangen?":"Wat wil jy ontvang?","De inschrijving voor deze kerk is op dit moment gesloten.":"Inskrywing vir hierdie gemeente is tans gesluit.","Inschrijving open — gemeenteleden kunnen zich via de QR/link aanmelden en zelf kiezen wat ze willen ontvangen":"Inskrywing oop — lidmate kan via die QR/skakel inteken en self kies wat hulle wil ontvang"
    ,"De eerste keer duurt even: de preek wordt gedownload, getranscribeerd en geanalyseerd. Zet bij stap 3 „automatisch ophalen\" aan, dan gebeurt dit vanzelf na de dienst en hoef je nergens op te wachten.":"Die eerste keer neem 'n rukkie: die preek word afgelaai, getranskribeer en ontleed. Skakel by stap 3 “outomaties ophaal” aan, dan gebeur dit vanself ná die diens en hoef jy nooit te wag nie."
    ,"maakt van je zondagse preek automatisch een weekboekje: een korte samenvatting en zeven dagoverdenkingen met vragen voor volwassenen en kinderen — en mailt die elke week naar je gemeenteleden.":"maak outomaties van jou Sondagspreek 'n weekboekie: 'n kort opsomming en sewe dagoordenkings met vrae vir volwassenes en kinders — en e-pos dit elke week aan jou lidmate.","Koppel je YouTube- of Kerkdienstgemist-kanaal en het gaat vanzelf.":"Koppel jou YouTube- of Kerkdienstgemist-kanaal en dit werk vanself.","Bekijk de demo":"Bekyk die demo","Je account maak je aan bij Community Tools.":"Jou rekening skep jy by Community Tools.","Daar beheer je al je kerk-apps op één plek. Je maakt (of gebruikt) daar je account en opent AfterSermon vervolgens vanuit Community Tools.":"Daar bestuur jy al jou gemeente-apps op een plek. Jy skep (of gebruik) daar jou rekening en open AfterSermon dan vanuit Community Tools.","Al een account? Open AfterSermon via Community Tools →":"Reeds 'n rekening? Open AfterSermon via Community Tools →"
  };
  let current = "nl";
